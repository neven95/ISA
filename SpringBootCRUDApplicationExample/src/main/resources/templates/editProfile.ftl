...
<div class="col-md-6 col-md-offset-3">
    ...
    <form name="registerForm" ng-submit="regCtrl.submit()" role="form">
                        <div class="form-group">
                            <input type="text" class="form-control" name="firstName" placeholder="First name" ng-pattern="regCtrl.firstNamePattern" ng-model="profCtrl.userData.firstName" ng-minlength="2" ng-maxlength="20" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="lastName" placeholder="Last name" ng-pattern="regCtrl.lastNamePattern" ng-model="profCtrl.userData.lastName" ng-minlength="2" ng-maxlength="20" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="phoneNumber" placeholder="Phone number" ng-pattern="regCtrl.phonePattern" ng-model="profCtrl.userData.phoneNumber" ng-minlength="10" ng-maxlength="10" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="city" placeholder="City" ng-model="profCtrl.userData.city" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="username" placeholder="Username" ng-pattern="regCtrl.usernamePattern" ng-model="profCtrl.userData.username" ng-minlength="3" ng-maxlength="10" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="email" placeholder="Email" ng-pattern="regCtrl.emailPattern" ng-model="profCtrl.userData.email" ng-minlength="3" ng-maxlength="128" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" name="password" placeholder="Password" ng-pattern="regCtrl.passwordPattern" ng-model="profCtrl.userData.password" ng-minlength="8" ng-maxlength="16" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="password" class="form-control" name="passwordRepeat" placeholder="Confirm Password"  ng-pattern="profCtrl.userData.password" ng-model="regCtrl.passwordRepeat" ng-minlength="8" ng-maxlength="16" ng-required="true"></input>
        ...
        <div class="form-actions">
            <button type="submit" ng-disabled="form.$invalid || regCtrl.dataLoading || registerForm.passwordRepeat.$error.pattern" class="btn btn-primary">Save changes</button>
