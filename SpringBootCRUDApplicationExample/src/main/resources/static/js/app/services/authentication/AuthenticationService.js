/*(function (){
    ...
    AuthenticationService.$inject = ['$http', '$cookies', '$rootScope', 'UserService', 'urls'];
    function AuthenticationService($http,$cookies, $rootScope, UserService, urls){
        var service={};
        service.Login = Login;
        ...
        function Login(userName, password, callback){
            $http.post(urls.LOGIN_SERVICE_API,{username: username, password: password})
                .success(function (response){
                    callback(response);
                });
        }
    }
    function SetCredentials(username, password, $rootScope) {
