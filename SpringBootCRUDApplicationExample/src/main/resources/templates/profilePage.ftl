    ...
    <div class="row">
        <div class="col-3 float-left " role="navigation">
            <nav class="nav flex-column">
                ...
                <a ng-hide="globals.currentUser.userType == '0' || globals.currentUser.userType == '1'" class="nav-link" ui-sref="guest-abstract.profile-abstract.profile-friends({username:globals.currentUser.username})">
                <i class="fas fa-users"></i> Friends
                </a>
                </a>
                <a ng-show="globals.currentUser.userType == '0' || globals.currentUser.userType == '1'" class="nav-link" ui-sref="guest-abstract.profile-abstract.profile-usersList">
