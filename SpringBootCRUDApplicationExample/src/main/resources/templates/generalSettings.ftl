...
<div class="col-md-6 col-md-offset-3">
    ...
    <form name="registerForm" ng-submit="settingsCtrl.submit()" role="form">
                        <div class="form-group">
                            <input type="text" class="form-control" name="firstName" placeholder="First name" ng-pattern="regCtrl.firstNamePattern" ng-model="settingsCtrl.userData.firstName" ng-minlength="2" ng-maxlength="20" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="lastName" placeholder="Last name" ng-pattern="regCtrl.lastNamePattern" ng-model="settingsCtrl.userData.lastName" ng-minlength="2" ng-maxlength="20" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="phoneNumber" placeholder="Phone number" ng-pattern="regCtrl.phonePattern" ng-model="settingsCtrl.userData.phoneNumber" ng-minlength="10" ng-maxlength="10" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="username" placeholder="Username" ng-pattern="regCtrl.usernamePattern" ng-model="settingsCtrl.userData.username" ng-minlength="3" ng-maxlength="10" ng-required="true"></input>
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control" name="email" placeholder="Email" ng-pattern="regCtrl.emailPattern" ng-model="settingsCtrl.userData.email" ng-minlength="3" ng-maxlength="128" ng-required="true"></input>
        ...
        <div class="form-actions">
            <button type="submit" ng-disabled="form.$invalid || settingsCtrl.dataLoading" class="btn btn-primary">Save changes</button>
